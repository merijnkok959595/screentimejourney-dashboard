...
const Signin = ()=>{
    ...
    const handleGoogleSignIn = ()=>{
        try {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$auth$2f$lib$2d$esm$2f$Auth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Auth"].federatedSignIn({
                provider: 'Google'
            });
        } catch (error) {
    ...
    const handleGitHubSignIn = ()=>{
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('GitHub sign in not configured yet');
        }
    };
